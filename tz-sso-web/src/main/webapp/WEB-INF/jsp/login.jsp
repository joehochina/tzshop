...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://www.tengzhuo.com"><img src="/images/logo.png" border="0"><span>欢迎登录</span></a>
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<a href="http://www.tengzhuo.com/html/activity/1472720729.html" target="_blank"><img src="/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>
		</div>
		<!-- login -->
		<div class="login">
			...
			<div class="login_box clear">
					...
					<form id="formlogin" method="post" >
						...
						<li>
							<div style="width: 65px; margin-left: 260px;">
								<a href="https://passport.tengzhuo.com/reg/findpass/?returnUrl=http://www.tengzhuo.com" class="forget-passWord">忘记密码?</a>
							</div>
						</li>
				...
				<ul class="blink">
					<li class="p-f10">
						...
						<div>
							<a href="http://api2.tengzhuo.com/unionlogin/qq/oauth/qq_login.php?returnUrl=http://www.tengzhuo.com/" class="link">QQ</a>&nbsp;|&nbsp; <a href="https://api.weibo.com/oauth2/authorize?client_id=1800908332&amp;redirect_uri=https%3A%2F%2Fpassport.tengzhuo.com%2Fcallback%2Fsina&amp;response_type=code&amp;state=&amp;display=?returnUrl=http://www.tengzhuo.com/" class="link">新浪微博</a> &nbsp;|&nbsp; <a href="https://open.t.qq.com/cgi-bin/oauth2/authorize?client_id=801198099&amp;redirect_uri=https%3A%2F%2Fpassport.tengzhuo.com%2Fcallback%2Fqq&amp;response_type=code&amp;type=?returnUrl=http://www.tengzhuo.com/" class="link">腾讯微博</a> &nbsp;|&nbsp; <a href="http://api2.tengzhuo.com/unionlogin/alipay.php?returnUrl=http://www.tengzhuo.com/" class="link">支付宝</a>
						</div>
					</li>
				</ul>
			</div>
	...
	<!-- /login_main -->
	<div class="footer">
		<span> <a href="http://www.tengzhuo.com/www/379/5109.html" rel="nofollow" class="footerlink1">关于我们</a> | <a href="http://www.tengzhuo.com/www/380/5116.html" rel="nofollow" class="footerlink1">联系我们</a> | <a href="http://www.tengzhuo.com/www/381/5117.html" rel="nofollow" class="footerlink1">招聘人才</a> | <a href="http://www.tengzhuo.com/www/330/2705.html" rel="nofollow" class="footerlink1">友情链接</a> | <a href="http://supplier.tengzhuo.com/supplierApply" rel="nofollow" class="footerlink1">供应商申请</a>
		</span>
		<p>
			深圳腾卓电子商务有限公司<br> 深圳市公安局宝安分局备案11006282001881号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">粤ICP备11022457号</a>|<a href="http://www.tengzhuo.com/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br> Copyright© 腾卓商城
			tengzhuo.com 版权所有<br>
		</p>
	</div>
	<!-- /footer -->
