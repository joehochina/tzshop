...
<body>
		<!-- header -->
		<div class="header">
			<a href="http://www.tengzhuo.com"><img src="/images/logo.png" border="0" /><span>欢迎注册</span></a>
		</div>
...
<div class="reg_main reg_border regTab" id="perDiv">
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="https://passport.tengzhuo.com/xy.html" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《腾卓商城用户注册协议》</font></a>
			</span>
    ...
    <div class="ui-reg-tip"><a href="http://help.tengzhuo.com/140/6788.html" target="_blank">了解更多>></a></div>
</div>
...
<!--mainOver-->
		...
		<div class="footer">
			<span>
				<a href="http://www.tengzhuo.com/www/379/5109.html" rel="nofollow" class="footerlink1">关于我们</a> | 
				<a href="http://www.tengzhuo.com/www/380/5116.html" rel="nofollow" class="footerlink1">联系我们</a> | 
				<a href="http://www.tengzhuo.com/www/381/5117.html" rel="nofollow" class="footerlink1">招聘人才</a> | 
				<a href="http://www.tengzhuo.com/www/330/2705.html" rel="nofollow" class="footerlink1">友情链接</a> | 
				<a href="http://supplier.tengzhuo.com/supplierApply" rel="nofollow" class="footerlink1">供应商申请</a>
			</span>
			<p> 
				深圳腾卓电子商务有限公司<br />
				深圳市公安局备案11006282001881号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">粤ICP备11022457号</a>|<a href="http://www.tengzhuo.com/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br />
				Copyright© 腾卓商城 tengzhuo.com 版权所有<br /> 
			</p>
		</div>
		<!-- /footer -->
